...
def main():
    ...
    #print_structure('C:/Users/Ben/Desktop/ann_data/Keras_iris/model.h5')

    b1_weights, b2_weights, b3_weights, h1_weights, h2_weights, h3_weights = [], [], [], [], [], []
    f = h5py.File('C:/Users/Ben/Desktop/ann_data/Keras_iris/model.h5')
    for layer, g in f.items():
        for p_name in g.keys():
            param = g[p_name]
            for k_name in param.keys():
    ...
    with open('C:/Users/Ben/Desktop/ann_data/Keras_iris/iris_weights.json', 'w') as outfile:
